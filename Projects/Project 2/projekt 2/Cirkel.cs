...
namespace projekt_2
{
    ...
    {
        int GammalX, GammalY;
        public Cirkel(int x, int y, Color c, int size) : base(x, y, c, size)
        {
        ...
        public override void RitaFigur(Graphics g)
        {
            ...
            if (GammalX != 0 && GammalY != 0)
            {
                g.DrawEllipse(penGammal, x1, y1, bredd2, höjd2);
            }
            ...
            if (x2 != 0 && y2 != 0)
            {
                g.DrawEllipse(pen, x1, y1, bredd, höjd);
            }
